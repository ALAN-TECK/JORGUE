...
wget https://raw.githubusercontent.com/ALAN-TECK/JORGUE/main/VPS/VPS-MAX.sh -O /usr/bin/VPS-MAX &> /dev/null
chmod +x /usr/bin/VPS-MAX
if [ "$REBOOT" = "1" ]; then
...
printTitle "Se procede a Instalar VPS-MAX  ALANTECK PERU"
echo $(date)
msg -bar2
sleep 7s
clear
